...
const dashboardLabels={analysis:'待我初析',review:'待我终验',overdue:'超期未闭环',high:'高风险未关闭',closed:'所选时段已关闭',focus:'重点关注',periodNew:'时段内新增',periodClosed:'时段内终验关闭',periodReturned:'时段内质量退回',periodReopened:'时段内重开'};
