...
const renderOriginalInitialWorkspaceHeader=renderInitialWorkspaceHeader;
renderInitialWorkspaceHeader=function(e){
 const status=tongAiHealth===null?'正在检查 AI 连接':tongAiHealth.connected?'原系统 AI 已连接':'AI 服务未就绪';
 return renderOriginalInitialWorkspaceHeader(e).replace(badge('交互模拟','blue'),badge(status,'blue'));
};
