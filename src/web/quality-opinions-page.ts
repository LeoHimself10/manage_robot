...
function clientScript(): string {
  ...
  var statusText={PENDING_ANALYSIS:'待质量初析',PENDING_ASSIGNMENT:'待分配',PENDING_ACCEPTANCE:'待承接',IN_PROGRESS:'处理中',PENDING_PRIMARY_REVIEW:'待原主责确认',PENDING_QUALITY_REVIEW:'待终验',CLOSED:'已关闭'};
